...
class DTO 
{
  ...
  */
  ...
  {
    global $logs;
    $logs['debug']->log("DTO construct called", PEAR_LOG_DEBUG);
  ...
  */
  function _log_sql_error(PDOException $e, $class, $function="")
  {
    ...
    $error_text = $e->getMessage();
    if(!empty($function)) $function = "in $function ";

    $logs['general']->log("SQL Error Occurred, see debug log file", PEAR_LOG_ERR);
    $logs['debug']->log("SQL Error generated by class '$class' $function ($error_text)", PEAR_LOG_EMERG);
  }
